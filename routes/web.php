...
// Rotas para TI (acessível apenas por cargo:1)
Route::middleware(['auth', 'cargo:1'])->group(function () {
    Route::get('/dashboard-ti', function () {
        return view('dashboard-ti');
    })->name('dashboard.ti');
});

// Rotas para Secretaria (acessível apenas por cargo:2)
Route::middleware(['auth', 'cargo:2'])->group(function () {
    ...
    // Rota de resource para Motoboys, acessível pela Secretaria
...
// Rotas para Motoboy (acessível apenas por cargo:3)
Route::middleware(['auth', 'cargo:3'])->group(function () {
