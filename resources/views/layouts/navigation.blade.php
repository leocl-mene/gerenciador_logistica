<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard.secretaria') }}">
                        <img src="{{ asset('images/logo.png') }}" alt="Logo Mene Portella" class="block h-10 w-auto">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard.secretaria')" :active="request()->routeIs('dashboard.secretaria')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    ...
                    @if(Auth::user()->cargo_id == 1)
                        ...
                        {{-- LINK DE RELATÓRIOS --}}
                        <x-nav-link :href="route('relatorios.index')" :active="request()->routeIs('relatorios.index') || request()->routeIs('relatorios.generate')">
                            {{ __('Relatórios') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard.secretaria')" :active="request()->routeIs('dashboard.secretaria')">
                {{ __('Dashboard') }}
            ...
            @if(Auth::user()->cargo_id == 1)
                ...
                {{-- LINK DE RELATÓRIOS --}}
                <x-responsive-nav-link :href="route('relatorios.index')" :active="request()->routeIs('relatorios.index') || request()->routeIs('relatorios.generate')">
                    {{ __('Relatórios') }}
                </x-responsive-nav-link>
            @endif
        </div>
